...
{
  // NS_LOG_FUNCTION (this);
 NS_LOG_INFO ("Sending Nist System Information Block at " << Simulator::Now().GetSeconds());
  ...
  if (m_sidelinkConfiguration && m_sidelinkConfiguration->IsSlEnabled()) {
     NS_LOG_INFO ("Sending Nist System Information Block 18 at " << Simulator::Now().GetSeconds());
    si.haveSib18 = true;
...
Ptr<LteEnbRrcSl> 
NistLteEnbRrc::GetSidelinkConfiguration (void)
{
  return m_sidelinkConfiguration;
}
