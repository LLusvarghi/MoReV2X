...
SciV2XLteControlMessage::SciV2XLteControlMessage (void)
{
  SetMessageType (NistLteControlMessage::SCI_V2X);
}


void
SciV2XLteControlMessage::SetSci (NistV2XSciListElement_s sci)
{
  m_v2x_sci = sci;
}
...
NistV2XSciListElement_s
SciV2XLteControlMessage::GetSci ()
{
  return m_v2x_sci;
}
