...
{
  m_scCpLen = "NORMAL"; //Sidelink Cyclic Prefix Length for PSCCH
  m_period = "sf40";    // Length of the SC Period in subframes
  m_scPrbNum = 22;
  m_scPrbStart = 0;
  m_scPrbEnd = 49;
  m_scOffset = 0;
  ...
  m_txParam = true;
  m_txAlpha = "al09";
  m_txP0 = -40; //the p0 parameter for the power control in the control channel
  m_dataAlpha = "al09";
  m_dataP0 = -4;
