...
NistLteSpectrumSignalParametersV2XSlFrame::NistLteSpectrumSignalParametersV2XSlFrame ()
{
  NS_LOG_FUNCTION (this);
}

NistLteSpectrumSignalParametersV2XSlFrame::NistLteSpectrumSignalParametersV2XSlFrame (const NistLteSpectrumSignalParametersV2XSlFrame& p)
: SpectrumSignalParameters (p)
{
  NS_LOG_FUNCTION (this << &p);
  nodeId = p.nodeId;
...
Ptr<SpectrumSignalParameters>
NistLteSpectrumSignalParametersV2XSlFrame::Copy ()
{
    NS_LOG_FUNCTION (this);
  // Ideally we would use:
  //   return Copy<NistLteSpectrumSignalParametersSlCtrlFrame> (*this);
  ...
  // but it causes a double creation of the object, hence it is less efficient.
  // The solution below is copied from the implementation of Copy<> (Ptr<>) in ptr.h
  Ptr<NistLteSpectrumSignalParametersV2XSlFrame> lssp (new NistLteSpectrumSignalParametersV2XSlFrame (*this), false);  
  return lssp;
}
