 ...
 */
#ifndef V2X_UDP_CLIENT_SERVER_HELPER_H
#define V2X_UDP_CLIENT_SERVER_HELPER_H
...
public:
   ...
   */
  V2xUdpServerHelper (uint16_t port);
...
public:
  ...
  V2xUdpClientHelper (Ipv4Address ip, uint16_t port);
  /**
   *  Create UdpClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
  ...
  V2xUdpClientHelper (Ipv6Address ip, uint16_t port);
  /**
   *  Create UdpClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
  ...
  V2xUdpClientHelper (Address ip, uint16_t port);
...
public:
   ...
   */
  V2xUdpTraceClientHelper (Address ip, uint16_t port, std::string filename);
  /**
   * Create UdpTraceClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
   ...
   * \param filename the file from which packet traces will be loaded
   */
  V2xUdpTraceClientHelper (Ipv4Address ip, uint16_t port, std::string filename);
  /**
   * Create UdpTraceClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
   ...
   * \param filename the file from which packet traces will be loaded
   */
  V2xUdpTraceClientHelper (Ipv6Address ip, uint16_t port, std::string filename);
