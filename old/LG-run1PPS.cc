...
double PrevX[282], PrevY[282], PrevZ[282], VelX[282], VelY[282], VelZ[282];  //20 is the number of nodes
double MeasInterval;
...
// Numero di ueResponders deve essere uguale al numero di nodi della simulazione SUMO
  ...
  Ns2MobilityHelper ns2 = Ns2MobilityHelper("/home/merani/Desktop/SumoTraces/3+3Lanes/50s/850VEH/RUN1/RUN1.tcl"); 
