...
double PrevX[270], PrevY[270], PrevZ[270], VelX[270], VelY[270], VelZ[270];  //20 is the number of nodes
double MeasInterval;
...
main (int argc, char *argv[])
{
  ...
  double simTime = 39; // The corrected simulation Time --> this is actually more
  double ueTxPower = 23.0; // [dBm]
  uint32_t ueCount = 270; // Number of V-UEs 
  bool verbose = true;
...
// Numero di ueResponders deve essere uguale al numero di nodi della simulazione SUMO
  ...
  Ns2MobilityHelper ns2 = Ns2MobilityHelper("/home/merani/Desktop/SumoTraces/Random/2Lanes/1000Vehicles/NEW.tcl"); 
