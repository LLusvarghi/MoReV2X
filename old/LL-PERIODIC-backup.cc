...
double PrevX[N_VEHICLES], PrevY[N_VEHICLES], PrevZ[N_VEHICLES], VelX[N_VEHICLES], VelY[N_VEHICLES], VelZ[N_VEHICLES];  //20 is the number of nodes
double MeasInterval;
...
main (int argc, char *argv[])
{
  ...
  uint32_t ueCount = N_VEHICLES; // Number of V-UEs 
  bool verbose = true;
...
// Numero di ueResponders deve essere uguale al numero di nodi della simulazione SUMO
  ...
  Ns2MobilityHelper ns2 = Ns2MobilityHelper("/home/merani/Desktop/SumoTraces/3+3Lanes/25s/1700VEH/RUN1/RUN1.tcl"); 
